...
public class InvestmentService {
    ...
    public InvestmentService(InvestmentRepository investmentRepository, UserService userService, ScpiRepository scpiRepository) {
        ...
        BankInfo response = new BankInfo();
            ...
            if (scpiOptional.isPresent()) {
                ...
                Investment investment = Investment.builder()
                        ...
                        .user_email(userService.getEmail())
    ...
    public Map<String, Object> getPortfolioPerformance() {
        ...
        List<Investment> investments = investmentRepository.findByUser_email(userEmail);
